  ...
  class IndividualUeContextDocumentApi
    ...
    def create_ue_context_with_http_info(ue_context_id, opts = {})
      ...
      if @api_client.config.client_side_validation && ue_context_id.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_id' when calling IndividualUeContextDocumentApi.create_ue_context"
      end
      pattern = Regexp.new(/^(5g-guti-[0-9]{5,6}[0-9a-fA-F]{14}|imsi-[0-9]{5,15}|nai-.+|imei-[0-9]{15}|imeisv-[0-9]{16}|.+)$/)
      if @api_client.config.client_side_validation && ue_context_id !~ pattern
        fail ArgumentError, "invalid value for 'ue_context_id' when calling IndividualUeContextDocumentApi.create_ue_context, must conform to the pattern #{pattern}."
      end
      ...
      header_params['Accept'] = @api_client.select_header_accept(['application/json', 'multipart/related', 'application/problem+json'])
      ...
      form_params['jsonData'] = opts[:'json_data'] if !opts[:'json_data'].nil?
      form_params['binaryDataN2Information'] = opts[:'binary_data_n2_information'] if !opts[:'binary_data_n2_information'].nil?
      form_params['binaryDataN2InformationExt1'] = opts[:'binary_data_n2_information_ext1'] if !opts[:'binary_data_n2_information_ext1'].nil?
      form_params['binaryDataN2InformationExt2'] = opts[:'binary_data_n2_information_ext2'] if !opts[:'binary_data_n2_information_ext2'].nil?
      form_params['binaryDataN2InformationExt3'] = opts[:'binary_data_n2_information_ext3'] if !opts[:'binary_data_n2_information_ext3'].nil?
      form_params['binaryDataN2InformationExt4'] = opts[:'binary_data_n2_information_ext4'] if !opts[:'binary_data_n2_information_ext4'].nil?
      form_params['binaryDataN2InformationExt5'] = opts[:'binary_data_n2_information_ext5'] if !opts[:'binary_data_n2_information_ext5'].nil?
      form_params['binaryDataN2InformationExt6'] = opts[:'binary_data_n2_information_ext6'] if !opts[:'binary_data_n2_information_ext6'].nil?
      form_params['binaryDataN2InformationExt7'] = opts[:'binary_data_n2_information_ext7'] if !opts[:'binary_data_n2_information_ext7'].nil?
      form_params['binaryDataN2InformationExt8'] = opts[:'binary_data_n2_information_ext8'] if !opts[:'binary_data_n2_information_ext8'].nil?
      form_params['binaryDataN2InformationExt9'] = opts[:'binary_data_n2_information_ext9'] if !opts[:'binary_data_n2_information_ext9'].nil?
      form_params['binaryDataN2InformationExt10'] = opts[:'binary_data_n2_information_ext10'] if !opts[:'binary_data_n2_information_ext10'].nil?
      form_params['binaryDataN2InformationExt11'] = opts[:'binary_data_n2_information_ext11'] if !opts[:'binary_data_n2_information_ext11'].nil?
      form_params['binaryDataN2InformationExt12'] = opts[:'binary_data_n2_information_ext12'] if !opts[:'binary_data_n2_information_ext12'].nil?
      form_params['binaryDataN2InformationExt13'] = opts[:'binary_data_n2_information_ext13'] if !opts[:'binary_data_n2_information_ext13'].nil?
      form_params['binaryDataN2InformationExt14'] = opts[:'binary_data_n2_information_ext14'] if !opts[:'binary_data_n2_information_ext14'].nil?
      form_params['binaryDataN2InformationExt15'] = opts[:'binary_data_n2_information_ext15'] if !opts[:'binary_data_n2_information_ext15'].nil?
      form_params['binaryDataN2InformationExt16'] = opts[:'binary_data_n2_information_ext16'] if !opts[:'binary_data_n2_information_ext16'].nil?
    ...
    def e_bi_assignment_with_http_info(ue_context_id, assign_ebi_data, opts = {})
      ...
      # verify the required parameter 'ue_context_id' is set
      if @api_client.config.client_side_validation && ue_context_id.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_id' when calling IndividualUeContextDocumentApi.e_bi_assignment"
      end
      pattern = Regexp.new(/^(5g-guti-[0-9]{5,6}[0-9a-fA-F]{14}|imsi-[0-9]{5,15}|nai-.+|imei-[0-9]{15}|imeisv-[0-9]{16}|.+)$/)
      if @api_client.config.client_side_validation && ue_context_id !~ pattern
        fail ArgumentError, "invalid value for 'ue_context_id' when calling IndividualUeContextDocumentApi.e_bi_assignment, must conform to the pattern #{pattern}."
      end

      # verify the required parameter 'assign_ebi_data' is set
      if @api_client.config.client_side_validation && assign_ebi_data.nil?
        fail ArgumentError, "Missing the required parameter 'assign_ebi_data' when calling IndividualUeContextDocumentApi.e_bi_assignment"
      end
      # resource path
      local_var_path = '/ue-contexts/{ueContextId}/assign-ebi'.sub('{' + 'ueContextId' + '}', CGI.escape(ue_context_id.to_s))
    ...
    def registration_status_update(ue_context_id, ue_reg_status_update_req_data, opts = {})
      data, _status_code, _headers = registration_status_update_with_http_info(ue_context_id, ue_reg_status_update_req_data, opts)
      data
    end
    ...
    def registration_status_update_with_http_info(ue_context_id, ue_reg_status_update_req_data, opts = {})
      ...
      # verify the required parameter 'ue_context_id' is set
      if @api_client.config.client_side_validation && ue_context_id.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_id' when calling IndividualUeContextDocumentApi.registration_status_update"
      end
      pattern = Regexp.new(/^(5g-guti-[0-9]{5,6}[0-9a-fA-F]{14}|imsi-[0-9]{5,15}|nai-.+|imei-[0-9]{15}|imeisv-[0-9]{16}|.+)$/)
      if @api_client.config.client_side_validation && ue_context_id !~ pattern
        fail ArgumentError, "invalid value for 'ue_context_id' when calling IndividualUeContextDocumentApi.registration_status_update, must conform to the pattern #{pattern}."
      end
      ...
      if @api_client.config.client_side_validation && ue_reg_status_update_req_data.nil?
        fail ArgumentError, "Missing the required parameter 'ue_reg_status_update_req_data' when calling IndividualUeContextDocumentApi.registration_status_update"
      end
      # resource path
      local_var_path = '/ue-contexts/{ueContextId}/transfer-update'.sub('{' + 'ueContextId' + '}', CGI.escape(ue_context_id.to_s))
    ...
    def release_ue_context_with_http_info(ue_context_id, ue_context_release, opts = {})
      ...
      # verify the required parameter 'ue_context_id' is set
      if @api_client.config.client_side_validation && ue_context_id.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_id' when calling IndividualUeContextDocumentApi.release_ue_context"
      end
      pattern = Regexp.new(/^(5g-guti-[0-9]{5,6}[0-9a-fA-F]{14}|imsi-[0-9]{5,15}|nai-.+|imei-[0-9]{15}|imeisv-[0-9]{16}|.+)$/)
      if @api_client.config.client_side_validation && ue_context_id !~ pattern
        fail ArgumentError, "invalid value for 'ue_context_id' when calling IndividualUeContextDocumentApi.release_ue_context, must conform to the pattern #{pattern}."
      end
      ...
      if @api_client.config.client_side_validation && ue_context_release.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_release' when calling IndividualUeContextDocumentApi.release_ue_context"
      end
      # resource path
      local_var_path = '/ue-contexts/{ueContextId}/release'.sub('{' + 'ueContextId' + '}', CGI.escape(ue_context_id.to_s))
    ...
    def u_e_context_transfer(ue_context_id, ue_context_transfer_req_data, opts = {})
      data, _status_code, _headers = u_e_context_transfer_with_http_info(ue_context_id, ue_context_transfer_req_data, opts)
      data
    end
    ...
    def u_e_context_transfer_with_http_info(ue_context_id, ue_context_transfer_req_data, opts = {})
      ...
      # verify the required parameter 'ue_context_id' is set
      if @api_client.config.client_side_validation && ue_context_id.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_id' when calling IndividualUeContextDocumentApi.u_e_context_transfer"
      end
      pattern = Regexp.new(/^(5g-guti-[0-9]{5,6}[0-9a-fA-F]{14}|imsi-[0-9]{5,15}|nai-.+|imei-[0-9]{15}|imeisv-[0-9]{16}|.+)$/)
      if @api_client.config.client_side_validation && ue_context_id !~ pattern
        fail ArgumentError, "invalid value for 'ue_context_id' when calling IndividualUeContextDocumentApi.u_e_context_transfer, must conform to the pattern #{pattern}."
      end
      ...
      if @api_client.config.client_side_validation && ue_context_transfer_req_data.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_transfer_req_data' when calling IndividualUeContextDocumentApi.u_e_context_transfer"
      end
      # resource path
      local_var_path = '/ue-contexts/{ueContextId}/transfer'.sub('{' + 'ueContextId' + '}', CGI.escape(ue_context_id.to_s))
