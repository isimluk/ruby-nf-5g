  ...
  class N1N2IndividualSubscriptionDocumentApi
    ...
    def n1_n2_message_un_subscribe_with_http_info(ue_context_id, subscription_id, opts = {})
      ...
      if @api_client.config.client_side_validation && ue_context_id.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_id' when calling N1N2IndividualSubscriptionDocumentApi.n1_n2_message_un_subscribe"
      end
      ...
      if @api_client.config.client_side_validation && ue_context_id !~ pattern
        fail ArgumentError, "invalid value for 'ue_context_id' when calling N1N2IndividualSubscriptionDocumentApi.n1_n2_message_un_subscribe, must conform to the pattern #{pattern}."
      end

      # verify the required parameter 'subscription_id' is set
      if @api_client.config.client_side_validation && subscription_id.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_id' when calling N1N2IndividualSubscriptionDocumentApi.n1_n2_message_un_subscribe"
      end
      # resource path
      local_var_path = '/ue-contexts/{ueContextId}/n1-n2-messages/subscriptions/{subscriptionId}'.sub('{' + 'ueContextId' + '}', CGI.escape(ue_context_id.to_s)).sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s))
