...
module OpenapiClient
  class N1N2MessageCollectionDocumentApi
    ...
    def n1_n2_message_transfer(ue_context_id, n1_n2_message_transfer_req_data, opts = {})
      data, _status_code, _headers = n1_n2_message_transfer_with_http_info(ue_context_id, n1_n2_message_transfer_req_data, opts)
      data
    end
    ...
    def n1_n2_message_transfer_with_http_info(ue_context_id, n1_n2_message_transfer_req_data, opts = {})
      ...
      if @api_client.config.client_side_validation && ue_context_id.nil?
        fail ArgumentError, "Missing the required parameter 'ue_context_id' when calling N1N2MessageCollectionDocumentApi.n1_n2_message_transfer"
      end
      pattern = Regexp.new(/^(imsi-[0-9]{5,15}|nai-.+|imei-[0-9]{15}|imeisv-[0-9]{16}|cid-.{1,255}|.+)$/)
      if @api_client.config.client_side_validation && ue_context_id !~ pattern
        fail ArgumentError, "invalid value for 'ue_context_id' when calling N1N2MessageCollectionDocumentApi.n1_n2_message_transfer, must conform to the pattern #{pattern}."
      end
      ...
      if @api_client.config.client_side_validation && n1_n2_message_transfer_req_data.nil?
        fail ArgumentError, "Missing the required parameter 'n1_n2_message_transfer_req_data' when calling N1N2MessageCollectionDocumentApi.n1_n2_message_transfer"
      end
      # resource path
      local_var_path = '/ue-contexts/{ueContextId}/n1-n2-messages'.sub('{' + 'ueContextId' + '}', CGI.escape(ue_context_id.to_s))
