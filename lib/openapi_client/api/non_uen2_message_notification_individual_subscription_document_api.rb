  ...
  class NonUEN2MessageNotificationIndividualSubscriptionDocumentApi
    ...
    def non_ue_n2_info_un_subscribe_with_http_info(n2_notify_subscription_id, opts = {})
      ...
      if @api_client.config.client_side_validation && n2_notify_subscription_id.nil?
        fail ArgumentError, "Missing the required parameter 'n2_notify_subscription_id' when calling NonUEN2MessageNotificationIndividualSubscriptionDocumentApi.non_ue_n2_info_un_subscribe"
      end
      # resource path
      local_var_path = '/non-ue-n2-messages/subscriptions/{n2NotifySubscriptionId}'.sub('{' + 'n2NotifySubscriptionId' + '}', CGI.escape(n2_notify_subscription_id.to_s))
