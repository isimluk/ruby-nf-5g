...
module OpenapiClient
  class CreateUEContextRequest
    attr_accessor :json_data, :binary_data_n2_information, :binary_data_n2_information_ext1,
                  :binary_data_n2_information_ext2, :binary_data_n2_information_ext3, :binary_data_n2_information_ext4, :binary_data_n2_information_ext5, :binary_data_n2_information_ext6, :binary_data_n2_information_ext7, :binary_data_n2_information_ext8, :binary_data_n2_information_ext9, :binary_data_n2_information_ext10, :binary_data_n2_information_ext11, :binary_data_n2_information_ext12, :binary_data_n2_information_ext13, :binary_data_n2_information_ext14, :binary_data_n2_information_ext15, :binary_data_n2_information_ext16
    ...
    def self.attribute_map
      {
        ...
        binary_data_n2_information_ext16: :binaryDataN2InformationExt16
      }
    end
    ...
    def self.openapi_types
      {
        ...
        binary_data_n2_information_ext16: :File
      }
    end
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `OpenapiClient::CreateUEContextRequest` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `OpenapiClient::CreateUEContextRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end

        h[k.to_sym] = v
      end

      self.json_data = attributes[:json_data] if attributes.key?(:json_data)
      ...
      return unless attributes.key?(:binary_data_n2_information_ext16)

      self.binary_data_n2_information_ext16 = attributes[:binary_data_n2_information_ext16]
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        binary_data_n2_information == other.binary_data_n2_information &&
        binary_data_n2_information_ext1 == other.binary_data_n2_information_ext1 &&
        binary_data_n2_information_ext2 == other.binary_data_n2_information_ext2 &&
        binary_data_n2_information_ext3 == other.binary_data_n2_information_ext3 &&
        binary_data_n2_information_ext4 == other.binary_data_n2_information_ext4 &&
        binary_data_n2_information_ext5 == other.binary_data_n2_information_ext5 &&
        binary_data_n2_information_ext6 == other.binary_data_n2_information_ext6 &&
        binary_data_n2_information_ext7 == other.binary_data_n2_information_ext7 &&
        binary_data_n2_information_ext8 == other.binary_data_n2_information_ext8 &&
        binary_data_n2_information_ext9 == other.binary_data_n2_information_ext9 &&
        binary_data_n2_information_ext10 == other.binary_data_n2_information_ext10 &&
        binary_data_n2_information_ext11 == other.binary_data_n2_information_ext11 &&
        binary_data_n2_information_ext12 == other.binary_data_n2_information_ext12 &&
        binary_data_n2_information_ext13 == other.binary_data_n2_information_ext13 &&
        binary_data_n2_information_ext14 == other.binary_data_n2_information_ext14 &&
        binary_data_n2_information_ext15 == other.binary_data_n2_information_ext15 &&
        binary_data_n2_information_ext16 == other.binary_data_n2_information_ext16
    end
    ...
    def hash
      [json_data, binary_data_n2_information, binary_data_n2_information_ext1, binary_data_n2_information_ext2,
       binary_data_n2_information_ext3, binary_data_n2_information_ext4, binary_data_n2_information_ext5, binary_data_n2_information_ext6, binary_data_n2_information_ext7, binary_data_n2_information_ext8, binary_data_n2_information_ext9, binary_data_n2_information_ext10, binary_data_n2_information_ext11, binary_data_n2_information_ext12, binary_data_n2_information_ext13, binary_data_n2_information_ext14, binary_data_n2_information_ext15, binary_data_n2_information_ext16].hash
    end
