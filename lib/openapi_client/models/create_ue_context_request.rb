...
module OpenapiClient
  class CreateUEContextRequest
    ...
    attr_accessor :binary_data_n2_information_ext16
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CreateUEContextRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CreateUEContextRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'binary_data_n2_information_ext16')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          binary_data_n2_information_ext16 == o.binary_data_n2_information_ext16
    end
