...
module OpenapiClient
  class N1MessageNotification
    attr_accessor :n1_notify_subscription_id

    attr_accessor :n1_message_container

    attr_accessor :lcs_correlation_id

    attr_accessor :registration_ctxt_container

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'n1_notify_subscription_id' => :'n1NotifySubscriptionId',
        :'n1_message_container' => :'n1MessageContainer',
        :'lcs_correlation_id' => :'lcsCorrelationId',
        :'registration_ctxt_container' => :'registrationCtxtContainer'
      }
    end
    ...
    def self.openapi_types
      {
        :'n1_notify_subscription_id' => :'String',
        :'n1_message_container' => :'N1MessageContainer',
        :'lcs_correlation_id' => :'String',
        :'registration_ctxt_container' => :'RegistrationContextContainer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::N1MessageNotification` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::N1MessageNotification`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'n1_notify_subscription_id')
        self.n1_notify_subscription_id = attributes[:'n1_notify_subscription_id']
      end

      if attributes.key?(:'n1_message_container')
        self.n1_message_container = attributes[:'n1_message_container']
      else
        self.n1_message_container = nil
      end
      ...
      if attributes.key?(:'registration_ctxt_container')
        self.registration_ctxt_container = attributes[:'registration_ctxt_container']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @n1_message_container.nil?
        invalid_properties.push('invalid value for "n1_message_container", n1_message_container cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @n1_message_container.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          n1_notify_subscription_id == o.n1_notify_subscription_id &&
          n1_message_container == o.n1_message_container &&
          lcs_correlation_id == o.lcs_correlation_id &&
          registration_ctxt_container == o.registration_ctxt_container
    end
    ...
    def hash
      [n1_notify_subscription_id, n1_message_container, lcs_correlation_id, registration_ctxt_container].hash
    end
