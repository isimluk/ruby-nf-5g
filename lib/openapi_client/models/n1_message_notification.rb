...
module OpenapiClient
  class N1MessageNotification
    attr_accessor :n1_notify_subscription_id, :n1_message_container, :lcs_correlation_id, :registration_ctxt_container
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `OpenapiClient::N1MessageNotification` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `OpenapiClient::N1MessageNotification`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      return unless attributes.key?(:registration_ctxt_container)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        n1_notify_subscription_id == other.n1_notify_subscription_id &&
        n1_message_container == other.n1_message_container &&
        lcs_correlation_id == other.lcs_correlation_id &&
        registration_ctxt_container == other.registration_ctxt_container
    end
