...
module OpenapiClient
  class N2InformationTransferReqData
    attr_accessor :tai_list, :rat_selector, :ecgi_list, :ncgi_list, :global_ran_node_list, :n2_information,
                  :supported_features
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `OpenapiClient::N2InformationTransferReqData` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `OpenapiClient::N2InformationTransferReqData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.rat_selector = attributes[:rat_selector] if attributes.key?(:rat_selector)
      ...
      self.n2_information = (attributes[:n2_information] if attributes.key?(:n2_information))
