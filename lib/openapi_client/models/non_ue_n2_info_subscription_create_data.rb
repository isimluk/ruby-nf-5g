...
module OpenapiClient
  class NonUeN2InfoSubscriptionCreateData
    ...
    attr_accessor :an_type_list

    attr_accessor :n2_information_class

    attr_accessor :n2_notify_callback_uri
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::NonUeN2InfoSubscriptionCreateData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::NonUeN2InfoSubscriptionCreateData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'an_type_list')
        if (value = attributes[:'an_type_list']).is_a?(Array)
          self.an_type_list = value
        end
      end

      if attributes.key?(:'n2_information_class')
        self.n2_information_class = attributes[:'n2_information_class']
      else
        self.n2_information_class = nil
      end

      if attributes.key?(:'n2_notify_callback_uri')
        self.n2_notify_callback_uri = attributes[:'n2_notify_callback_uri']
      else
        self.n2_notify_callback_uri = nil
      end

      if attributes.key?(:'nf_id')
        self.nf_id = attributes[:'nf_id']
      end
    ...
    def list_invalid_properties
      ...
      if !@an_type_list.nil? && @an_type_list.length < 1
    ...
    def valid?
      ...
      return false if !@an_type_list.nil? && @an_type_list.length < 1
    ...
    def an_type_list=(an_type_list)
      if an_type_list.nil?
        fail ArgumentError, 'an_type_list cannot be nil'
      end

      if an_type_list.length < 1
        fail ArgumentError, 'invalid value for "an_type_list", number of items must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          an_type_list == o.an_type_list &&
          n2_information_class == o.n2_information_class &&
          n2_notify_callback_uri == o.n2_notify_callback_uri &&
          nf_id == o.nf_id &&
