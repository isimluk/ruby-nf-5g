...
module OpenapiClient
  class UeContextCreateData
    attr_accessor :ue_context, :target_id, :source_to_target_data, :pdu_session_list, :n2_notify_uri,
                  :ue_radio_capability, :ngap_cause, :supported_features
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `OpenapiClient::UeContextCreateData` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `OpenapiClient::UeContextCreateData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.target_id = (attributes[:target_id] if attributes.key?(:target_id))

      self.source_to_target_data = (attributes[:source_to_target_data] if attributes.key?(:source_to_target_data))
      ...
      self.n2_notify_uri = attributes[:n2_notify_uri] if attributes.key?(:n2_notify_uri)

      self.ue_radio_capability = attributes[:ue_radio_capability] if attributes.key?(:ue_radio_capability)

      self.ngap_cause = attributes[:ngap_cause] if attributes.key?(:ngap_cause)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "target_id", target_id cannot be nil.') if @target_id.nil?
    ...
    def valid?
      ...
      return false if @pdu_session_list.empty?
    ...
    def pdu_session_list=(pdu_session_list)
      raise ArgumentError, 'pdu_session_list cannot be nil' if pdu_session_list.nil?

      if pdu_session_list.empty?
        raise ArgumentError, 'invalid value for "pdu_session_list", number of items must be greater than or equal to 1.'
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        source_to_target_data == other.source_to_target_data &&
        pdu_session_list == other.pdu_session_list &&
        n2_notify_uri == other.n2_notify_uri &&
        ue_radio_capability == other.ue_radio_capability &&
        ngap_cause == other.ngap_cause &&
    ...
    def hash
      [ue_context, target_id, source_to_target_data, pdu_session_list, n2_notify_uri, ue_radio_capability, ngap_cause,
       supported_features].hash
    end
