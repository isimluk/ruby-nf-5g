...
module OpenapiClient
  class UeContextCreatedData
    attr_accessor :ue_context, :target_to_source_data, :pdu_session_list, :failed_session_list, :supported_features,
                  :pcf_reselected_ind
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `OpenapiClient::UeContextCreatedData` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `OpenapiClient::UeContextCreatedData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.target_to_source_data = (attributes[:target_to_source_data] if attributes.key?(:target_to_source_data))
      ...
      if attributes.key?(:failed_session_list) && (value = attributes[:failed_session_list]).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if !@failed_session_list.nil? && @failed_session_list.empty?
    ...
    def valid?
      ...
      return false if !@failed_session_list.nil? && @failed_session_list.empty?
    ...
    def failed_session_list=(failed_session_list)
      raise ArgumentError, 'failed_session_list cannot be nil' if failed_session_list.nil?

      if failed_session_list.empty?
        raise ArgumentError,
              'invalid value for "failed_session_list", number of items must be greater than or equal to 1.'
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        target_to_source_data == other.target_to_source_data &&
        pdu_session_list == other.pdu_session_list &&
        failed_session_list == other.failed_session_list &&
    ...
    def hash
      [ue_context, target_to_source_data, pdu_session_list, failed_session_list, supported_features,
       pcf_reselected_ind].hash
    end
