...
module OpenapiClient
  class UeN1N2InfoSubscriptionCreateData
    attr_accessor :n2_information_class, :n2_notify_callback_uri, :n1_message_class, :n1_notify_callback_uri, :nf_id,
                  :supported_features
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `OpenapiClient::UeN1N2InfoSubscriptionCreateData` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `OpenapiClient::UeN1N2InfoSubscriptionCreateData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.n1_notify_callback_uri = attributes[:n1_notify_callback_uri] if attributes.key?(:n1_notify_callback_uri)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        n1_notify_callback_uri == other.n1_notify_callback_uri &&
        nf_id == other.nf_id &&
    ...
    def hash
      [n2_information_class, n2_notify_callback_uri, n1_message_class, n1_notify_callback_uri, nf_id,
