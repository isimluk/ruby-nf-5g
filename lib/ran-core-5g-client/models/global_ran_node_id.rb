  ...
  class GlobalRanNodeId
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Core5g::GlobalRanNodeId` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Core5g::GlobalRanNodeId`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.g_nb_id = attributes[:g_nb_id] if attributes.key?(:g_nb_id)

      self.nge_nb_id = attributes[:nge_nb_id] if attributes.key?(:nge_nb_id)

      self.wagf_id = attributes[:wagf_id] if attributes.key?(:wagf_id)

      self.tngf_id = attributes[:tngf_id] if attributes.key?(:tngf_id)

      self.nid = attributes[:nid] if attributes.key?(:nid)

      return unless attributes.key?(:e_nb_id)

      self.e_nb_id = attributes[:e_nb_id]
    end
    ...
    def list_invalid_properties
      ...
      if !@nge_nb_id.nil? && @nge_nb_id !~ pattern
        invalid_properties.push("invalid value for \"nge_nb_id\", must conform to the pattern #{pattern}.")
      end

      pattern = /^[A-Fa-f0-9]+$/
      if !@wagf_id.nil? && @wagf_id !~ pattern
        invalid_properties.push("invalid value for \"wagf_id\", must conform to the pattern #{pattern}.")
      end

      pattern = /^[A-Fa-f0-9]+$/
      if !@tngf_id.nil? && @tngf_id !~ pattern
        invalid_properties.push("invalid value for \"tngf_id\", must conform to the pattern #{pattern}.")
      end
      ...
      if !@e_nb_id.nil? && @e_nb_id !~ pattern
        invalid_properties.push("invalid value for \"e_nb_id\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      if !@nge_nb_id.nil? && @nge_nb_id !~ /^(MacroNGeNB-[A-Fa-f0-9]{5}|LMacroNGeNB-[A-Fa-f0-9]{6}|SMacroNGeNB-[A-Fa-f0-9]{5})$/
        return false
      end
      return false if !@wagf_id.nil? && @wagf_id !~ /^[A-Fa-f0-9]+$/
      return false if !@tngf_id.nil? && @tngf_id !~ /^[A-Fa-f0-9]+$/
      return false if !@nid.nil? && @nid !~ /^[A-Fa-f0-9]{11}$/
      if !@e_nb_id.nil? && @e_nb_id !~ /^(MacroeNB-[A-Fa-f0-9]{5}|LMacroeNB-[A-Fa-f0-9]{6}|SMacroeNB-[A-Fa-f0-9]{5}|HomeeNB-[A-Fa-f0-9]{7})$/
        return false
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] nge_nb_id Value to be assigned
    def nge_nb_id=(nge_nb_id)
      raise ArgumentError, 'nge_nb_id cannot be nil' if nge_nb_id.nil?

      pattern = /^(MacroNGeNB-[A-Fa-f0-9]{5}|LMacroNGeNB-[A-Fa-f0-9]{6}|SMacroNGeNB-[A-Fa-f0-9]{5})$/
      unless nge_nb_id&.match?(pattern)
        raise ArgumentError, "invalid value for \"nge_nb_id\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] wagf_id Value to be assigned
    def wagf_id=(wagf_id)
      raise ArgumentError, 'wagf_id cannot be nil' if wagf_id.nil?

      pattern = /^[A-Fa-f0-9]+$/
      unless wagf_id&.match?(pattern)
        raise ArgumentError, "invalid value for \"wagf_id\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] tngf_id Value to be assigned
    def tngf_id=(tngf_id)
      raise ArgumentError, 'tngf_id cannot be nil' if tngf_id.nil?

      pattern = /^[A-Fa-f0-9]+$/
      unless tngf_id&.match?(pattern)
        raise ArgumentError, "invalid value for \"tngf_id\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_nb_id Value to be assigned
    def e_nb_id=(e_nb_id)
      raise ArgumentError, 'e_nb_id cannot be nil' if e_nb_id.nil?

      pattern = /^(MacroeNB-[A-Fa-f0-9]{5}|LMacroeNB-[A-Fa-f0-9]{6}|SMacroeNB-[A-Fa-f0-9]{5}|HomeeNB-[A-Fa-f0-9]{7})$/
      unless e_nb_id&.match?(pattern)
        raise ArgumentError, "invalid value for \"e_nb_id\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        g_nb_id == other.g_nb_id &&
        nge_nb_id == other.nge_nb_id &&
        wagf_id == other.wagf_id &&
        tngf_id == other.tngf_id &&
        nid == other.nid &&
        e_nb_id == other.e_nb_id
    end
    ...
    def hash
      [plmn_id, n3_iwf_id, g_nb_id, nge_nb_id, wagf_id, tngf_id, nid, e_nb_id].hash
    end
