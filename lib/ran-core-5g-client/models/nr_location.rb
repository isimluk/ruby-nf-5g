...
module Core5g
  ...
  class NrLocation
    attr_accessor :tai, :ncgi, :ignore_ncgi, :global_gnb_id
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError, 'The input argument (attributes) must be a hash in `Core5g::NrLocation` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Core5g::NrLocation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.ncgi = (attributes[:ncgi] if attributes.key?(:ncgi))

      self.ignore_ncgi = if attributes.key?(:ignore_ncgi)
                           attributes[:ignore_ncgi]
                         else
                           false
                         end
      ...
      return unless attributes.key?(:global_gnb_id)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "ncgi", ncgi cannot be nil.') if @ncgi.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        global_gnb_id == other.global_gnb_id
    end
    ...
    def hash
      [tai, ncgi, ignore_ncgi, age_of_location_information, ue_location_timestamp, geographical_information,
       geodetic_information, global_gnb_id].hash
    end
