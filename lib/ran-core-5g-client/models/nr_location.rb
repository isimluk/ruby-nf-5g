...
module Core5g
  class NrLocation
    attr_accessor :tai, :ncgi, :age_of_location_information, :ue_location_timestamp, :geographical_information,
                  :geodetic_information, :global_gnb_id
    ...
    def hash
      [tai, ncgi, age_of_location_information, ue_location_timestamp, geographical_information, geodetic_information,
       global_gnb_id].hash
    end
