...
module Core5g
  ...
  class RedirectResponse
    ...
    attr_accessor :target_scp

    # String providing an URI formatted according to RFC 3986.
    attr_accessor :target_sepp
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Core5g::RedirectResponse` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Core5g::RedirectResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.target_scp = attributes[:target_scp] if attributes.key?(:target_scp)

      return unless attributes.key?(:target_sepp)

      self.target_sepp = attributes[:target_sepp]
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        cause == other.cause &&
        target_scp == other.target_scp &&
        target_sepp == other.target_sepp
    end
    ...
    def hash
      [cause, target_scp, target_sepp].hash
    end
