...
module Core5g
  ...
  class SupportedSnssai
    attr_accessor :s_nssai, :restriction_ind
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Core5g::SupportedSnssai` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Core5g::SupportedSnssai`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.restriction_ind = if attributes.key?(:restriction_ind)
                               attributes[:restriction_ind]
                             else
                               false
                             end
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        restriction_ind == other.restriction_ind
    end
