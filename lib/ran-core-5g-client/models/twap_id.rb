...
module Core5g
  ...
  class TwapId
    ...
    attr_accessor :bss_id

    # string with format 'bytes' as defined in OpenAPI
    attr_accessor :civic_address
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError, 'The input argument (attributes) must be a hash in `Core5g::TwapId` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Core5g::TwapId`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end

        h[k.to_sym] = v
      end

      self.ss_id = (attributes[:ss_id] if attributes.key?(:ss_id))

      self.bss_id = attributes[:bss_id] if attributes.key?(:bss_id)

      return unless attributes.key?(:civic_address)

      self.civic_address = attributes[:civic_address]
    end
    ...
    def list_invalid_properties
      ...
      invalid_properties = []
      invalid_properties.push('invalid value for "ss_id", ss_id cannot be nil.') if @ss_id.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ss_id == other.ss_id &&
        bss_id == other.bss_id &&
        civic_address == other.civic_address
    end
    ...
    def hash
      [ss_id, bss_id, civic_address].hash
    end
